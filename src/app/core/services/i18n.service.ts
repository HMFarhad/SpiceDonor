  ...
  public translate(key: string): string {
    const translations: Record<SupportedLanguage, Record<string, string>> = {
      en: {
        ...
        'Phone': 'Phone',
        'Email': 'Email',
        'L = Lactose Free | G = Gluten Free | K = Vegetarian | V = Vegan': 'L = Lactose Free | G = Gluten Free | K = Vegetarian | V = Vegan',
        ...
        'Phone': 'Puhelin',
        'Email': 'Sähköposti',
        'L = Lactose Free | G = Gluten Free | K = Vegetarian | V = Vegan': 'L = Laktoositon | G = Gluteeniton | K = Vegetaarinen | V = Vegaani',
