  ...
  public translate(key: string): string {
    const translations: Record<SupportedLanguage, Record<string, string>> = {
      en: {
        ...
        'hero_specialty_pitas': 'Fresh pitas & wraps',
        'hero_specialty_bowls': 'Colorful mezze bowls',
        'hero_specialty_falafel': 'Hummus & falafel',
        ...
        'about_giving_title': 'Giving Back',
        'about_giving_text': 'We set aside a small percentage of our profits to support people experiencing poverty and those who lack access to basic human needs.',
        ...
        'hero_specialty_pitas': 'Tuoreet pitat ja wrapit',
        'hero_specialty_bowls': 'Värikkäät mezze-kulhot',
        'hero_specialty_falafel': 'Hummus ja falafel',
        ...
        'about_giving_title': 'Hyvän tekeminen',
        'about_giving_text': 'Ohjaamme pienen osan voitoistamme köyhyyttä kokevien ja ilman elämän perustarpeita elävien ihmisten tukemiseen.',
